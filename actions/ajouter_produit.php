...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $stmt_etape = mysqli_prepare($conn, "INSERT INTO etapes_tracabilite (produit_id, acteur_id, etape, description, lieu, date_etape) VALUES (?, ?, ?, ?, ?, NOW())");
        mysqli_stmt_bind_param($stmt_etape, "iisss", $produit_id, $producteur_id, $etape, $desc_etape, $origine);
